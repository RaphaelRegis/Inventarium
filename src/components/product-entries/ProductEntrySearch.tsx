...
import styles from './ProductEntrySearch.module.css';
import { SortOrder } from '@/hooks/useProductEntries';
...
export default function ProductEntrySearch({
    searchQuery,
    setSearchQuery,
    branchFilter,
    setBranchFilter,
